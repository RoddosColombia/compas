...
| # | Capacidad | Estado |
|---|---|---|
| C1 | **Categorías administrables** (crear/editar/desactivar desde la app) | ❌ **FALTA** (solo semilla, sin CRUD) |
...
| C7 | **Proyección de caja** y capa predictiva (objetivos de venta, fecha pago proveedores, IVA mínimo, deuda/inversión) | ❌ **FALTA** (es el valor final; Fase 1.5+) |
...
1. **C1 — categorías administrables (CRUD de rubros).**
