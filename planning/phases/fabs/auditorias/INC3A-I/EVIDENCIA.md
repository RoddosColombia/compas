...
@@ -61,15 +64,16 @@ async def ejecutar_tool(nombre: str) -> ResultadoCFO:
...
@@ -39,6 +60,11 @@ _RE_MESES = re.compile(r"(\d+(?:[.,]\d+)?)\s*mes(?:es)?\b", re.IGNORECASE)
...
@@ -86,6 +112,7 @@ def _es_monto(raw: str) -> bool:
 class Veredicto:
     ok: bool
...
@@ -131,48 +158,22 @@ def extraer_cifras(texto: str) -> list[tuple[Decimal, str, str]]:
...
@@ -11,211 +23,197 @@ from app.cfo.agente.verificador import extraer_cifras, verificar
 from app.cfo.calc.evidencia import Evidencia, ResultadoCFO
