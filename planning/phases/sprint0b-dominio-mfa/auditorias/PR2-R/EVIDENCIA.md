# EVIDENCIA — sprint0b-dominio-mfa · PR2-R (fixes de I-PR2)

Fix commit `f625f65` sobre `385682a`. Solo el diff de los hallazgos.

## 1. pytest (suite completa)

```
166 passed, 9 skipped, 9 warnings in ~133s
(2 tests nuevos vs I-PR2: challenge no reutilizable [M1], re-enrolar sin step-up 403 [B1])
```
...
## 4. git diff --stat (385682a..f625f65)

```
 backend/app/auth/deps.py                           |   33 +-
 backend/app/auth/router.py                         |   17 +-
 backend/app/auth/service.py                        |   10 +-
 backend/tests/test_auth_mfa_endpoints.py           |   25 +-
 backend/tests/test_auth_mfa_flow.py                |   24 +
 docs/COMPAS_Control_Desarrollo.xlsx                |  Bin 19372 -> 19516 bytes
 docs/COMPAS_ERRATA_PENDIENTE_v1_1_3.md             |    9 +
 docs/RUNBOOK-INFRA.md                              |    8 +-
 .../auditorias/PR2-I/EVIDENCIA.md                  | 1380 ++++++++++++++++++++
 .../auditorias/PR2-I/RESPUESTA.md                  |   32 +
 .../auditorias/PR2-I/SOLICITUD.md                  |   55 +
 render.yaml                                        |    6 +
 12 files changed, 1582 insertions(+), 17 deletions(-)
```
...
index e0248fe..f11b514 100644
--- a/backend/app/auth/deps.py
+++ b/backend/app/auth/deps.py
@@ -36,23 +36,36 @@ async def get_current_user(
...
+    await repository.denylist_add(jti, _exp_dt(claims))
     ...
     now = now_utc()
     family_id = uuid4().hex
diff --git a/backend/tests/test_auth_mfa_endpoints.py b/backend/tests/test_auth_mfa_endpoints.py
index 9f0a6ce..710bd9c 100644
--- a/backend/tests/test_auth_mfa_endpoints.py
+++ b/backend/tests/test_auth_mfa_endpoints.py
...
@@ -108,6 +108,29 @@ async def test_step_up_bloquea_sin_mfa_reciente(api):
...
+
 async def test_step_up_ok_tras_verify(api):
     ...
     access = await _login(api)
diff --git a/backend/tests/test_auth_mfa_flow.py b/backend/tests/test_auth_mfa_flow.py
index 6ca235e..aeb6853 100644
--- a/backend/tests/test_auth_mfa_flow.py
+++ b/backend/tests/test_auth_mfa_flow.py
...
diff --git a/docs/COMPAS_Control_Desarrollo.xlsx b/docs/COMPAS_Control_Desarrollo.xlsx
index 27bb859..6b04929 100644
Binary files a/docs/COMPAS_Control_Desarrollo.xlsx and b/docs/COMPAS_Control_Desarrollo.xlsx differ
diff --git a/docs/COMPAS_ERRATA_PENDIENTE_v1_1_3.md b/docs/COMPAS_ERRATA_PENDIENTE_v1_1_3.md
index c6c97cd..cb249b3 100644
--- a/docs/COMPAS_ERRATA_PENDIENTE_v1_1_3.md
+++ b/docs/COMPAS_ERRATA_PENDIENTE_v1_1_3.md
...
index fa59ccc..bfe2e92 100644
--- a/docs/RUNBOOK-INFRA.md
+++ b/docs/RUNBOOK-INFRA.md
@@ -91,7 +91,13 @@ Procedimiento de compromiso: rotar el secreto afectado → `token_version` globa
...
diff --git a/planning/phases/sprint0b-dominio-mfa/auditorias/PR2-I/EVIDENCIA.md b/planning/phases/sprint0b-dominio-mfa/auditorias/PR2-I/EVIDENCIA.md
new file mode 100644
index 0000000..c77f45a
--- /dev/null
+++ b/planning/phases/sprint0b-dominio-mfa/auditorias/PR2-I/EVIDENCIA.md
@@ -0,0 +1,1380 @@
...
+
+```
diff --git a/planning/phases/sprint0b-dominio-mfa/auditorias/PR2-I/RESPUESTA.md b/planning/phases/sprint0b-dominio-mfa/auditorias/PR2-I/RESPUESTA.md
new file mode 100644
index 0000000..8bb9b1a
--- /dev/null
+++ b/planning/phases/sprint0b-dominio-mfa/auditorias/PR2-I/RESPUESTA.md
@@ -0,0 +1,32 @@
...
diff --git a/planning/phases/sprint0b-dominio-mfa/auditorias/PR2-I/SOLICITUD.md b/planning/phases/sprint0b-dominio-mfa/auditorias/PR2-I/SOLICITUD.md
new file mode 100644
index 0000000..a4b0fe4
--- /dev/null
+++ b/planning/phases/sprint0b-dominio-mfa/auditorias/PR2-I/SOLICITUD.md
@@ -0,0 +1,55 @@
...
@@ -95,6 +99,8 @@ services:
         value: America/Bogota
       - key: MONGODB_URI_COMPAS   # apunta a compas_stg (datos anonimizados, F-25)
         sync: false
+      - key: MONGODB_URI_AUDIT
+        sync: false
       - key: JWT_SECRET
         sync: false
       - key: MFA_ENC_KEY
