...
SYSTEM_PROMPT = (
    ...
    "'cerrado' (último mes cerrado), 'acumulado' (últimos 3 meses con "
    "movimientos) o 'curso' (último mes con movimientos). Devuelve "
    "gasto_total_comp (el gasto total en COP) y, por cada "
